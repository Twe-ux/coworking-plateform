    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.details && Array.isArray(result.details)) {
          ...
          setErrors({ general: result.error || 'Erreur lors de la création de l\'employé' })
        }
      }
    } catch (error) {
            ...
            <CardContent className="pt-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-5 gap-3">
                  {EMPLOYEE_COLORS.map((color) => (
                    <button
                      ...
                      className={`relative p-3 rounded-lg border-2 transition-all ${
                        formData.color === color.value 
                          ? 'border-coffee-primary ring-2 ring-coffee-primary/20' 
                    ...
                    >
                      ...
                      {formData.color === color.value && (
                        <div className="absolute top-1 right-1 w-3 h-3 bg-coffee-primary rounded-full" />
                      )}
                    </button>
                  ))}
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <Badge 
                    className={`${formData.color} text-white`}
                  >
