    ...
    <div className="flex h-screen flex-col">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          >
            <Shield className="h-6 w-6" style={{ color: 'var(--color-vert-foret)' }} />
          </div>
          <div>
        ...
        >
          <Avatar className="h-9 w-9">
            ...
            <AvatarFallback style={{ backgroundColor: 'var(--color-vert-doux)' }}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs truncate" style={{ color: 'var(--color-vert-doux)' }}>
              Super Admin
            </p>
          </div>
        </div>
      ...
      {/* Navigation admin */}
      <nav className="flex-1 overflow-y-auto p-4" style={{ backgroundColor: '#f8fffe' }}>
          ...
          {adminSidebarItems.map((item) => {
            ...
            return (
              <Link
                ...
                style={{
                  backgroundColor: isActive ? 'var(--color-vert-doux)' : 'transparent',
                  borderColor: isActive ? 'var(--color-vert-foret)' : 'transparent',
                  color: isActive ? 'var(--color-vert-foret)' : '#374151'
                }}
              >
                <Icon className={cn(
                  'h-5 w-5 transition-colors',
                  isActive ? 'text-[var(--color-vert-foret)]' : 'text-gray-500'
                )} />
                <div className="flex-1 min-w-0">
      ...
      <div 
        ...
        style={{ borderColor: 'var(--color-vert-doux)', backgroundColor: '#f8fffe' }}
      >
        <div 
          className="rounded-lg p-3 text-center"
          style={{ backgroundColor: 'var(--color-vert-doux)', color: 'var(--color-vert-foret)' }}
        >
