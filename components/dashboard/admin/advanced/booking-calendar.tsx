...
import { format, addDays, startOfWeek, endOfWeek, isSameDay, parseISO, startOfMonth, endOfMonth, addMonths, subMonths, isSameMonth } from 'date-fns'
...
export function BookingCalendar() {
  ...
  const filterBookings = useCallback(() => {
    ...
    if (spaceFilter !== 'all') {
      filtered = filtered.filter(booking => booking.spaceId.name === spaceFilter)
    }
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="grid grid-cols-7">
                {calendarDays.map((day, index) => (
                  <div
                    key={index}
                    className={`min-h-24 p-1 border-r border-b last-in-row:border-r-0 ${
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-medium text-sm text-gray-600">Espace</h4>
                ...
                <div>
                  <h4 className="font-medium text-sm text-gray-600">Statut</h4>
                  <div className="mt-1">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-sm text-gray-600">Date et horaires</h4>
                  <div className="mt-1 space-y-1">
                    <div className="flex items-center space-x-2">
                      <CalendarIcon className="h-4 w-4 text-gray-400" />
                      <span>{format(parseISO(selectedBooking.date), 'dd MMMM yyyy', { locale: fr })}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                ...
                <div>
                  <h4 className="font-medium text-sm text-gray-600">Détails</h4>
                  <div className="mt-1 space-y-1">
                    <div className="flex items-center space-x-2">
                      <Users className="h-4 w-4 text-gray-400" />
                      <span>{selectedBooking.guests} personne{selectedBooking.guests > 1 ? 's' : ''}</span>
                    </div>
                    <div className="flex items-center space-x-2">
