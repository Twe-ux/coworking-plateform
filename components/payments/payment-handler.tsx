      ...
      {paymentMethod === 'onsite' && (
        <div className="space-y-4 text-center">
          <div className="flex justify-center">
            <div className="bg-coffee-primary/10 rounded-full p-4">
              <Coffee className="text-coffee-primary h-8 w-8" />
            </div>
          </div>
          <div>
          ...
          <Button
            ...
            className="bg-coffee-primary hover:bg-coffee-primary/90 w-full"
