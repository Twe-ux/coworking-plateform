...
interface PDFCashControlProps {
  data: RowData[]
  selectedMonth: number | null
  selectedYear: number | null
}

export default function PDFCashControl({
  data,
  selectedMonth,
  selectedYear,
}: PDFCashControlProps) {
              ...
              >
                {table.getHeaderGroups().map((headerGroup) => (
                  <RowTabTurnover
                    key={headerGroup.id}
                    firstCell={
                      typeof headerGroup.headers[0].column.columnDef.header ===
                      'function'
                    ...
                    secCell={
                      typeof headerGroup.headers[8].column.columnDef.header ===
                      'function'
                    ...
                    thirdCell={
                      typeof headerGroup.headers[9].column.columnDef.header ===
                      'function'
                    ...
                    fourthCell={
                      typeof headerGroup.headers[7].column.columnDef.header ===
                      'function'
              ...
              >
                {table.getHeaderGroups().map((headerGroup) => (
                  <RowTabTurnover
                    ...
                    secCell={
                      typeof headerGroup.headers[1].column.columnDef.header ===
                      'function'
