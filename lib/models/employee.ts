...
const employeeSchema = new Schema<IEmployee>(
  {
    ...
    role: {
      ...
      enum: {
        values: ['Manager', 'Reception', 'Security', 'Maintenance', 'Cleaning', 'Staff'],
        message: 'Rôle invalide. Rôles autorisés: Manager, Reception, Security, Maintenance, Cleaning, Staff',
      },
    },
    color: {
      type: String,
      ...
      validate: {
        ...
        message: 'Format de couleur invalide. Utilisez une classe Tailwind (ex: bg-blue-500) ou un code hex (ex: #3B82F6)',
      },
    },
    startDate: {
      type: Date,
